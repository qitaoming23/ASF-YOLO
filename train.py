...
if __name__ == '__main__':
    ...
    parser.add_argument('--cfg', type=str, default='/models/transformer/yolov5s_fusion_mambax3_vedai.yaml', help='model.yaml path')
    parser.add_argument('--data', type=str, default='./data/multispectral/fold8.yaml', help='data.yaml path')
