...
if __name__ == "__main__":
    ...
    y = model_ref.forward(x)
    print(y.shape)
    x = torch.randn(32, 128, 80, 80).cuda()
    model2 = VSSBlock(128, drop_path_rate=0.0, norm_layer=LayerNorm2d,channel_first=True,ssm_d_state=1,ssm_ratio=1.0, ssm_dt_rank="auto",ssm_act_layer=nn.SiLU,ssm_init='v0',forward_type='v05_noz').cuda()
    y=model2(x).cuda()
    print(y.shape)
