...
if __name__ == '__main__':
    ...
    parser.add_argument('--weights', nargs='+', type=str, default='/home/wdblink/github/multispectral-object-detection/runs/train/exp28/weights/best.pt', help='model.pt path(s)')
    parser.add_argument('--source1', type=str, default='/home/wdblink/Dataset/dense_region/VocFormat/images/trainval_rgb', help='source')  # file/folder, 0 for webcam
    parser.add_argument('--source2', type=str, default='/home/wdblink/Dataset/dense_region/VocFormat/images/trainval_dsm', help='source')  # file/folder, 0 for webcam
