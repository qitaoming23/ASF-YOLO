...
def test(data,
    ...
    # for batch_i, (img, targets, paths, shapes) in enumerate(tqdm(testloader, desc=s)):
        ...
        img = img.to(torch.float32) # uint8 to fp16/32
...
if __name__ == '__main__':
    ...
    parser.add_argument('--weights', nargs='+', type=str, default='runs/train/exp_CMAFF_fold3/weights/part_of_training.pt', help='model.pt path(s)')
    parser.add_argument('--data', type=str, default='data/multispectral/fold3.yaml', help='*.data path')
