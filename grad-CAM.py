...
class yolov5_heatmap:
    ...
    def __call__(self, img_path, save_path):
        ...
        tensor2 = torch.from_numpy(np.transpose(img1, axes=[2, 0, 1])).unsqueeze(0).to(self.device)
        ...
        for i in trange(int(post_result.size(0) * self.ratio)):
            ...
            saliency_map = cv2.resize(saliency_map, (tensor1.size(3), tensor1.size(2)))
            ...
            cam_image = show_cam_on_image(img1.copy(), saliency_map, use_rgb=True)
...
def get_params():
    params = {
        'weight': 'runs/train/exp_add_DOM&DSM/weights/part_of_training.pt',
        'cfg': 'models/transformer/yolov5s_fusion_add_vedai.yaml',
        'device': 'cuda:0',
...
if __name__ == '__main__':
    ...
    model(r'datasets/RGB-DSM/VocFormat/images/val_images/000000000003.tif', 'result')