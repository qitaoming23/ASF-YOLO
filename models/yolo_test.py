...
from models.mamba_models.yolo_vss import VSSNet
...
if __name__ == '__main__':
    ...
    parser.add_argument('--cfg', type=str, default='./yolov5s_fusion_mambax3_vedai.yaml', help='model.yaml')
    ...
    flops, params = profile(model, inputs=(input_rgb, input_ir))
